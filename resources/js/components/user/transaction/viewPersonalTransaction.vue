            ...
            <Column header="Action" class="align-middle">
                <template #body="{ data }">
                    <div class="btn-group" role="group">
                        <button class="btn btn-outline-warning mx-2" @click="viewTransaction"> <i
...
import AddTransaction from '../../transactions/addTransaction.vue';
...
const gettransactions = async () => {
    try {
        ...
        const response = await axios.get(`http://localhost:8000/api/transaction/${userId}`);
